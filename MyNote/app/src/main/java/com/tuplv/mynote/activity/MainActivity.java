...
import com.tuplv.mynote.adapter.SearchMainActivity;
...
//tạo fragment
        ...
        mediaPlayer = MediaPlayer.create(this,R.raw.thieunienmongnhien);
        mediaPlayer.start();
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.mnuUpdateOld:
                ...
                break;
            case R.id.mnuUpdateAZ:
                SORT=3;
                if (currentFragment == FRAGMENT_NOTE){
                    replaceFragment(new NoteFragment());
                }
                break;
            case R.id.mnuUpdateZA:
                SORT=4;
                if (currentFragment == FRAGMENT_NOTE){
                    replaceFragment(new NoteFragment());
                }
                break;
            case R.id.mnuSeaechTitle:
