...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String sqlCreateTableNote =
                "CREATE TABLE IF NOT EXISTS " + TABLE_NOTE + "(id INTEGER PRIMARY KEY AUTOINCREMENT, id_category INTEGER, title TEXT, content TEXT, color TEXT, created_at TEXT, updated_at TEXT, " +
    ...
    public List<Note> sortAZ(String type){
        List<Note> list=new ArrayList<>();
    ...
    public List<Note> FindTitle(String titleSearch){
        List<Note> list =new ArrayList<>();
    ...
    public List<Note> SearchDate(String startDate,String endDate ){
        List<Note> list =new ArrayList<>();
